 ...
 * - **Add agent** — bounded, verified in-memory fetch → existing importer
 ...
 * flow presents the decoded agent details.
 */
      ...
      setImportState({
        ...
        message:
          err instanceof Error
            ? err.message
            : "Couldn’t load this agent. Try again.",
      });
    } finally {
